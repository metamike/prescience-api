...
describe IncomeTaxActivity, model: true do
  ...
  context 'validations' do
    ...
    [:adjusted_gross_income, :taxable_income, :federal_itemized_deductions, :federal_income_tax,
        :federal_income_tax_owed, :state_income_tax, :state_income_tax_owed].each do |field|
